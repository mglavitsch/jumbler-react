...
// 1) Delete old files starting with THIRD-PARTY-LICENSES and matching the regex
...
// 2) execute webpack --mode=production
console.log("Running webpack build...");
execSync("webpack --mode=production", { stdio: "inherit" });

// 3) Read prod license file and derive hash
...
// 4) Copy prod license file to new hashed license file
